...
namespace DotNetCoreKoans.Koans
{
    ...
    public class AboutMethods : Koan
    {
        ...
        {
            Assert.Equal(this.MethodWithVariableArguments("Cory", "Will", "Corey"), this.MethodWithVariableArguments("Cory", "Will", "Corey"));
        }
        ...
        {
            Assert.Equal(this.LocalMethodWithVariableParameters("Cory", "Will", "Corey"), this.LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
        ...
        {
            Assert.Equal(LocalMethodWithVariableParameters("Cory", "Will", "Corey"), LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
